...
@section('breadcrumbs')
    <nav class="flex items-center space-x-2">
        ...
        <span class="text-sm text-gray-500">CTA Section</span>
    </nav>
@endsection
@section('page-icon')
    <i class="fas fa-bullhorn fa-lg text-gray-700"></i>
@endsection
@section('page-title')
    <h1 class="text-2xl font-bold text-gray-900">CTA Section Management</h1>
    <p class="text-gray-600 text-sm mt-1">Manage and customize the Call-to-Action section for your website.</p>
@endsection
