...
@section('breadcrumbs')
    <nav class="flex items-center space-x-2">
        ...
        <span class="text-sm text-gray-500">Loan Plans Section</span>
    </nav>
@endsection
@section('page-icon')
    <i class="fas fa-money-bill-wave fa-lg text-gray-700"></i>
@endsection
@section('page-title')
...
@section('title', 'Loan Plans Section Management')
@section('content')
    ...
    <div class="admin-panel" id="adminPanel" role="dialog" aria-labelledby="adminPanelTitle" aria-modal="true">
        ...
        <form id="loanPlansForm" method="POST" action="{{ route('management.price-section') }}"
