...
@section('breadcrumbs')
    <nav class="flex items-center space-x-2">
        ...
        <span class="text-gray-400">/</span>
        <span class="text-sm text-gray-500">Edit User - {{ $user->first_name }} {{ $user->last_name }}</span>
    </nav>
@endsection
@section('page-icon')
...
@endsection
@section('page-title')
    <h1 class="text-2xl font-bold text-gray-900">Edit User - {{ $user->first_name }} {{ $user->last_name }}</h1>
                    ...
                    <form action="{{ route('management.users.update', $user) }}" method="POST"
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-6">
                                    <label for="password" class="block text-sm font-medium text-gray-700 mb-2">Change
                                        Password
                                ...
                                <div class="flex items-center space-x-6">
                                    ...
                                    <div class="flex-1">
                                        <label for="profile_picture"
                                            class="block text-sm font-medium text-gray-700 mb-2">Upload New Profile
                                            Picture</label>
