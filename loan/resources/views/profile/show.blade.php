                        ...
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-900">{{ $user->first_name }} {{ $user->last_name }}
                                    </p>
                                </div>
                                <div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                        <div class="p-6">
                            ...
                            <div class="space-y-3">
                                ...
                                @if ($user->locked_at)
                                    <form action="{{ route('management.unlock', $user) }}" method="POST" class="w-full">
                                        @csrf
                                        <button type="submit"
                                            class="w-full flex items-center justify-between px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-200 text-left">
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-900">{{ $user->created_at->format('F j, Y g:i A') }}
                                    </p>
                                </div>
                                <div>
