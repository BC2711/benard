...
@section('content')
    <div class="max-w-6xl mx-auto p-6">
        ...
        <form action="{{ route('admin.hero.update', $hero) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
            @method('PUT')
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    @if ($hero->hero_image)
                        <img src="{{ asset('storage/' . $hero->hero_image) }}" alt="Current" class="mt-2 h-32 rounded">
                    @endif
                </div>
            </div>
